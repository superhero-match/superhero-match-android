...
import nl.mwsoft.www.superheromatch.viewLayer.main.fragment.profile.SuggestionProfileImageFragment;

public class ProfileViewPagerAdapter extends FragmentPagerAdapter {

    private Superhero superhero;

    public ProfileViewPagerAdapter(FragmentManager fm, Superhero superhero) {
        super(fm);
